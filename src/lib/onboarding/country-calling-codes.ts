/**
 * ITU-T E.164 country calling codes for the mobile intake control.
 *
 * Dial codes can be shared (United States and Canada are both +1). The
 * picker lists each territory so the customer can choose the right
 * extension; the stored value is `+{dial} {nationalNumber}`.
 */
...
export const COUNTRY_CALLING_CODES: CountryCallingCode[] = [
  ...
  { iso: "VC", name: "St Vincent and the Grenadines", dial: "1784" },
...
export const DEFAULT_CALLING_DIAL = "91";
export const DEFAULT_CALLING_ISO = "IN";
